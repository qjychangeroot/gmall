...
public class SpuInfoController {
    ...
    @GetMapping
    private Resp<PageVo> querySpuInfoByKeyPage(@RequestParam(value = "catId",defaultValue = "0")Long catId,QueryCondition queryCondition){
       PageVo pageVo = this.spuInfoService.querySpuInfoByKeyPage(catId,queryCondition);
